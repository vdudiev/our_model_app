...
import 'package:our_mediapipe_app/constanst/model_file.dart';
...
class FaceDetection extends AiModel {
  ...
  Map<String, dynamic>? predict(image_lib.Image image) {
    ...
    final tensorImage = TensorImage(TensorBufferFloat.datatype);
    ...
    var detections = process(options: options, rawScores: rawScores, rawBoxes: rawBoxes, anchors: _anchors);
